...
YTDLP = '/home/khaled/.local/bin/yt-dlp'
MAX_BATCH = 20
FILE_TTL = 600  # seconds before downloaded file is removed
...
def do_batch_convert(job_id, urls, cookie_path=None):
    ...
    with jobs_lock:
        jobs[job_id].update(status='done', file=zip_path, filename='ytmp3_batch.zip')
...
if __name__ == '__main__':
    app.run(host='127.0.0.1', port=13000, debug=False)
